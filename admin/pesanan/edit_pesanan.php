<?php
if (isset($_GET['kode'])) {
	$sql_cek = "SELECT * FROM tb_pdd WHERE id_pesanan='" . $_GET['kode'] . "'";
	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-2">
					<input type="text" class="form-control" id="id_pesanan" name="id_pesanan" value="<?php echo $data_cek['id_pesanan']; ?>" readonly />
				</div>
			</div>
