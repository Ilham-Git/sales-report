	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" class="form-control" id="wilayah" name="wilayah" placeholder="Wilayah" value="<?php echo $user ?>" readonly>
				</div>
			</div>
...
if (isset($_POST['Simpan'])) {
	...
	if ($query_simpan) {
      ...
      Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=add-toko-sales';
          }
      })</script>";
	}
}
